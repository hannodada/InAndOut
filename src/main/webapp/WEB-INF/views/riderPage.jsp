...
<jsp:include page="realGnb.jsp"/>
    ...
    <div class="main-box">
        ...
        <c:if test="${new_photo_name eq null}">
			     		 		<img src="resources/photo/프로필 기본.png"  style="width: 130px;">
	     				</c:if>
			     		 <c:if test="${new_photo_name ne null}">
			     		 		<img src="/photo/${new_photo_name}"  style="width: 130px; position: relative;">
	     				</c:if>
        
            <div class="title-nickname" style="position: absolute; bottom: 20px;">
            <h2>${dto.nickname}</h2>
            </div>
        </div>
        <div class="content">
