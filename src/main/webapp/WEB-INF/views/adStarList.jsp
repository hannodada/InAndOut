...
<jsp:include page="adminbox.jsp"/>
	...
	<article>
		<h2 style="color: #708090;">별점 목록</h2>
...
function listPrint(list){
	   ...
	   list.forEach(function(item){
	      ...
	      content +='<td>'+item.cate_no+'</td>';
	      content +='<td id="userdiv">'+item.cate_name+'</td>';
	  
	      content +='<td id="subject"><a href="ad.starupdate.go?cate_no='+ item.cate_no +'">' + "수정" + '</a></td>';
	      content +='</tr>';
